...
Dir = '/media/joao/HD-jao/Calibrador_GLM/Prototipo_1_AED2_Zoop/'
...
f_parametros = 'Parametros_de_calibracao_AED2_Zoop.txt'
...
for i, row in dt_parametros.iterrows():
    ...
    Folder_new = f'{Dir}Modelos_Calibracao/{f_base_model}_{i}_Zoop/'
    ...
    nml = f90nml.read(Folder_base + '/aed2_zoop_pars.nml')
    ...
    # Altera as configuraµções do .nml para ficar igual ao do cenário
    os.remove(Folder_new + '/aed2_zoop_pars.nml')
    nml.write(Folder_new + '/aed2_zoop_pars.nml')