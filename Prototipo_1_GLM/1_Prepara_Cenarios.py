...
f_base_model = 'EllenBrook_Base'
# Arquivo com as combinações dos parâmetros de teste para calibracao
f_parametros = 'Parametros_de_calibracao.txt'
...
for i in range(0, len(Dics_Cenarios)):
    ...
    Folder_new = f'{Dir}Modelos_Calibracao/{f_base_model}_{i}/'
    ...
    f90nml.patch(Folder_base + '/glm3.nml', Dics_Cenarios[i], Folder_new + '/glm3.nml')
